...
public class ShulchanAruchParserTest {
    ...
    public static void setup() throws Exception {
        for (int seferNum = 1; seferNum <= NUM_OF_SFARIM; seferNum++) {
            ...
            createOutputFolderIfNotExists("shulchanaruch");
            parser.parse(reader, "json/shulchanaruch/shulchanaruch-" + seferNum + ".json");
            json[seferNum] = getJson("json/shulchanaruch/shulchanaruch-" + seferNum + ".json");
            packageJson[seferNum] = getJson("json/shulchanaruch/shulchanaruch-" + seferNum + "-packages.json");
        }
    }
...
//            assertEquals(numOfSeifimPerSefer(seferNum) ,json[seferNum].subjects.size());
//        }
//    }

    // This test adds failures and we currently do not have a quick method for counting the expected objects...
//    @Test
...
//    }
    ...
    public void testSpecificObjects(){
        ...
        assertTextUriProperty(object, "shulchanaruch-1-1-1");
        //assertTextUriProperty(object, "shulchanaruch", object.get(JBO_SEFER));
        //assertEquals("shulchanaruch-1", object.get(JBO_CHELEK));
        //assertTextUriProperty(object, "shulchanaruch-halachot-1-1", object.get(JBO_HALACHOT));
        //assertTextUriProperty(object, "shulchanaruch-1-1", object.get(JBO_SIMAN));
        ...
        assertBookProperty(object,"shulchanaruch");
        //perush
        object = json[1].getObject(1);
        assertTextUriProperty(object, "shulchanaruch-baerheytev-1-1-1");
        assertEquals(JBR_TEXT + "shulchanaruch-1-1-1", object.get(JBO_INTERPRETS));
        //assertTextUriProperty(object, "shulchanaruch-baerheytev", object.get(JBO_SEFER));
        //assertEquals("shulchanaruch-1", object.get(JBO_CHELEK));
        //assertTextUriProperty(object, "shulchanaruch-halachot-1-1", object.get(JBO_HALACHOT));
        //assertTextUriProperty(object, "shulchanaruch-1-1", object.get(JBO_SIMAN));
        assertEquals("1", object.get(JBO_POSITION_IN_SIMAN));
        assertPositionProperty(object ,"1");
        assertEquals("באר היטב אורח חיים הלכות הנהגת אדם בבוקר א א", object.get(RDFS_LABEL));
        ...
        assertEquals(text, object.get(JBO_TEXT));
        assertBookProperty(object,"baerheytev");

        //sefer 1 siman 2 saif 3
        object = json[1].getObject(20);
        assertTextUriProperty(object, "shulchanaruch-1-2-3");
        //assertTextUriProperty(object, "shulchanaruch", object.get(JBO_SEFER));
        //assertEquals("shulchanaruch-1", object.get(JBO_CHELEK));
        //assertTextUriProperty(object, "shulchanaruch-halachot-1-1", object.get(JBO_HALACHOT));
        //assertTextUriProperty(object, "shulchanaruch-1-2", object.get(JBO_SIMAN));
        ...
        assertTextUriProperty(object, "shulchanaruch-baerheytev-1-2-3");
        assertEquals(JBR_TEXT + "shulchanaruch-1-2-3", object.get(JBO_INTERPRETS));
        //assertTextUriProperty(object, "shulchanaruch-baerheytev", object.get(JBO_SEFER));
        //assertEquals("shulchanaruch-1", object.get(JBO_CHELEK));
        //assertTextUriProperty(object, "shulchanaruch-halachot-1-1", object.get(JBO_HALACHOT));
        //assertTextUriProperty(object, "shulchanaruch-1-2", object.get(JBO_SIMAN));
        assertEquals("3", object.get(JBO_POSITION_IN_SIMAN));
        assertPositionProperty(object ,"12");
        assertEquals("באר היטב אורח חיים הלכות הנהגת אדם בבוקר ב ג", object.get(RDFS_LABEL));
        ...
        assertTextUriProperty(object, "shulchanaruch-1-697-1");
        //assertTextUriProperty(object, "shulchanaruch", object.get(JBO_SEFER));
        //assertEquals("shulchanaruch-1", object.get(JBO_CHELEK));
        //assertTextUriProperty(object, "shulchanaruch-halachot-1-39", object.get(JBO_HALACHOT));
        //assertTextUriProperty(object, "shulchanaruch-1-697", object.get(JBO_SIMAN));
        assertEquals("1", object.get(JBO_POSITION_IN_SIMAN));
//        assertEquals("4167");
        ...
        assertTextUriProperty(object, "shulchanaruch-2-29-1");
        //assertTextUriProperty(object, "shulchanaruch", object.get(JBO_SEFER));
        //assertEquals("shulchanaruch-2", object.get(JBO_CHELEK));
        //assertTextUriProperty(object, "shulchanaruch-halachot-2-2", object.get(JBO_HALACHOT));
        //assertTextUriProperty(object, "shulchanaruch-2-29", object.get(JBO_SIMAN));
        assertEquals("1", object.get(JBO_POSITION_IN_SIMAN));
        assertPositionProperty(object ,"177");
        ...
        assertTextUriProperty(object, "shulchanaruch-baerheytev-2-29-1");
        assertEquals(JBR_TEXT + "shulchanaruch-2-29-1", object.get(JBO_INTERPRETS));
        //assertTextUriProperty(object, "shulchanaruch-baerheytev", object.get(JBO_SEFER));
        //assertEquals("shulchanaruch-2", object.get(JBO_CHELEK));
        //assertTextUriProperty(object, "shulchanaruch-halachot-2-2", object.get(JBO_HALACHOT));
        //assertTextUriProperty(object, "shulchanaruch-2-29", object.get(JBO_SIMAN));
        assertEquals("1", object.get(JBO_POSITION_IN_SIMAN));
        assertPositionProperty(object ,"177");
        assertEquals("באר היטב יורה דעה הלכות טרפות כט א", object.get(RDFS_LABEL));
        ...
        assertTextUriProperty(object, "shulchanaruch-2-403-9");
        //assertTextUriProperty(object, "shulchanaruch", object.get(JBO_SEFER));
        //assertEquals("shulchanaruch-2", object.get(JBO_CHELEK));
        //assertTextUriProperty(object, "shulchanaruch-halachot-2-60", object.get(JBO_HALACHOT));
        //assertTextUriProperty(object, "shulchanaruch-2-403", object.get(JBO_SIMAN));
...
//        assertEquals("3493");
        ...
        assertTextUriProperty(object, "shulchanaruch-baerheytev-2-403-9");
        assertEquals(JBR_TEXT + "shulchanaruch-2-403-9", object.get(JBO_INTERPRETS));
        //assertTextUriProperty(object, "shulchanaruch-baerheytev", object.get(JBO_SEFER));
        //assertEquals("shulchanaruch-2", object.get(JBO_CHELEK));
        //assertTextUriProperty(object, "shulchanaruch-halachot-2-60", object.get(JBO_HALACHOT));
        //assertTextUriProperty(object, "shulchanaruch-2-403", object.get(JBO_SIMAN));
        assertEquals("9", object.get(JBO_POSITION_IN_SIMAN));
//        assertEquals("3493");
        assertEquals("באר היטב יורה דעה הלכות אבילות תג ט", object.get(RDFS_LABEL));
        ...
        assertTextUriProperty(object, "shulchanaruch-3-1-6");
        //assertTextUriProperty(object, "shulchanaruch", object.get(JBO_SEFER));
        //assertEquals("shulchanaruch-3", object.get(JBO_CHELEK));
        //assertTextUriProperty(object, "shulchanaruch-halachot-3-1", object.get(JBO_HALACHOT));
        //assertTextUriProperty(object, "shulchanaruch-3-1", object.get(JBO_SIMAN));
        ...
        assertTextUriProperty(object, "shulchanaruch-baerheytev-3-1-6");
        assertEquals(JBR_TEXT + "shulchanaruch-3-1-6", object.get(JBO_INTERPRETS));
        //assertTextUriProperty(object, "shulchanaruch-baerheytev", object.get(JBO_SEFER));
        //assertEquals("shulchanaruch-3", object.get(JBO_CHELEK));
        //assertTextUriProperty(object, "shulchanaruch-halachot-3-1", object.get(JBO_HALACHOT));
        //assertTextUriProperty(object, "shulchanaruch-3-1", object.get(JBO_SIMAN));
        assertEquals("6", object.get(JBO_POSITION_IN_SIMAN));
        assertPositionProperty(object ,"6");
        assertEquals("באר היטב אבן העזר הלכות פריה ורביה א ו", object.get(RDFS_LABEL));
        ...
        assertTextUriProperty(object, "shulchanaruch-3-177-4");
        //assertTextUriProperty(object, "shulchanaruch", object.get(JBO_SEFER));
        //assertEquals("shulchanaruch-3", object.get(JBO_CHELEK));
        //assertTextUriProperty(object, "shulchanaruch-halachot-3-8", object.get(JBO_HALACHOT));
        //assertTextUriProperty(object, "shulchanaruch-3-177", object.get(JBO_SIMAN));
...
//        assertEquals("1875");
        ...
        assertTextUriProperty(object, "shulchanaruch-baerheytev-3-177-4");
        assertEquals(JBR_TEXT + "shulchanaruch-3-177-4", object.get(JBO_INTERPRETS));
        //assertTextUriProperty(object, "shulchanaruch-baerheytev", object.get(JBO_SEFER));
        //assertEquals("shulchanaruch-3", object.get(JBO_CHELEK));
        //assertTextUriProperty(object, "shulchanaruch-halachot-3-8", object.get(JBO_HALACHOT));
        //assertTextUriProperty(object, "shulchanaruch-3-177", object.get(JBO_SIMAN));
        assertEquals("4", object.get(JBO_POSITION_IN_SIMAN));
//        assertEquals("1875");
        assertEquals("באר היטב אבן העזר הלכות חליצה קעז ד", object.get(RDFS_LABEL));
        ...
        assertTextUriProperty(object, "shulchanaruch-4-1-6");
        //assertTextUriProperty(object, "shulchanaruch", object.get(JBO_SEFER));
        //assertEquals("shulchanaruch-4", object.get(JBO_CHELEK));
        //assertTextUriProperty(object, "shulchanaruch-halachot-4-1", object.get(JBO_HALACHOT));
        //assertTextUriProperty(object, "shulchanaruch-4-1", object.get(JBO_SIMAN));
        assertEquals("6", object.get(JBO_POSITION_IN_SIMAN));
        assertPositionProperty(object ,"6");
        ...
        assertTextUriProperty(object, "shulchanaruch-baerheytev-4-1-6");
        assertEquals(JBR_TEXT + "shulchanaruch-4-1-6", object.get(JBO_INTERPRETS));
        //assertTextUriProperty(object, "shulchanaruch-baerheytev", object.get(JBO_SEFER));
        //assertEquals("shulchanaruch-4", object.get(JBO_CHELEK));
        //assertTextUriProperty(object, "shulchanaruch-halachot-4-1", object.get(JBO_HALACHOT));
        //assertTextUriProperty(object, "shulchanaruch-4-1", object.get(JBO_SIMAN));
        assertEquals("6", object.get(JBO_POSITION_IN_SIMAN));
        assertPositionProperty(object ,"6");
        assertEquals("באר היטב חשן משפט הלכות דיינים א ו", object.get(RDFS_LABEL));
        ...
        assertTextUriProperty(object, "shulchanaruch-4-425-3");
        //assertTextUriProperty(object, "shulchanaruch", object.get(JBO_SEFER));
        //assertEquals("shulchanaruch-4", object.get(JBO_CHELEK));
        //assertTextUriProperty(object, "shulchanaruch-halachot-4-41", object.get(JBO_HALACHOT));
        //assertTextUriProperty(object, "shulchanaruch-4-425", object.get(JBO_SIMAN));
        assertEquals("3", object.get(JBO_POSITION_IN_SIMAN));
//        assertEquals("3690");
        ...
        assertTextUriProperty(object, "shulchanaruch-baerheytev-4-425-3");
        assertEquals(JBR_TEXT + "shulchanaruch-4-425-3", object.get(JBO_INTERPRETS));
        //assertTextUriProperty(object, "shulchanaruch-baerheytev", object.get(JBO_SEFER));
        //assertEquals("shulchanaruch-4", object.get(JBO_CHELEK));
        //assertTextUriProperty(object, "shulchanaruch-halachot-4-41", object.get(JBO_HALACHOT));
        //assertTextUriProperty(object, "shulchanaruch-4-425", object.get(JBO_SIMAN));
        assertEquals("3", object.get(JBO_POSITION_IN_SIMAN));
//        assertEquals("3690");
        assertEquals("באר היטב חשן משפט הלכות חובל בחבירו תכה ג", object.get(RDFS_LABEL));
    ...
    public void testSpecificPackages(){
        ...
        assertEquals(JBR_SECTION + "shulchanaruch-halachot-3-6",object.get(URI));
        assertEquals("הלכות מאון",object.get(RDFS_LABEL));
        assertPositionProperty(object ,"6");
        //sefer 3 halachot 3 siman 26
        object = packageJson[3].getObject(JBR_SECTION + "shulchanaruch-3-26");
        assertEquals("שלא לקדש בביאה, ואסור ביאה על הפנויה אפלו אם יחדה",object.get(RDFS_LABEL));
        assertPositionProperty(object ,"26");

        //sefer 4
        object = packageJson[4].getObject(0);
        assertEquals(JBR_SECTION + "shulchanaruch-4",object.get(URI));
        assertEquals("שלחן ערוך - חשן משפט",object.get(RDFS_LABEL));
        assertPositionProperty(object ,"4");
        //sefer 4 halachot 2
        object = packageJson[4].getObject(JBR_SECTION + "shulchanaruch-halachot-4-2");
        ...
        assertEquals(JBR_SECTION + "shulchanaruch-4-421",object.get(URI));
        assertEquals("המביש חברו שלא בכונה, והחובל בחברו שלא בכונה",object.get(RDFS_LABEL));
        assertPositionProperty(object ,"421");
    }



    private int numOfSeifimPerSefer(int seferNum) {
        int numOfSeifimPerSefer[] = {-1, 4802, 5978, 2959, 6530};
        return numOfSeifimPerSefer[seferNum];
    }

    // this adds failures and we currently do not have a quick method for counting the expected objects...
