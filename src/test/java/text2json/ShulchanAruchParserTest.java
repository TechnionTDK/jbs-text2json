...
import static text2json.parsers.ShulhanAruchParser.JBO_POSITION_IN_SIMAN;
import static text2json.parsers.ShulhanAruchParser.JBO_SIMAN;
...
public class ShulchanAruchParserTest {
    ...
    public void testSpecificObjects(){
        ...
        assertEquals("jbr:shulchanaruch-1-1-1-1", object.get(URI));
        assertEquals("shulchanaruch-1", object.get(JBO_SEFER));
        assertEquals("דין השכמת הבוקר", object.get(JBO_SIMAN));
        ...
        assertEquals("jbr:shulchanaruch-perush-1-1-1-1", object.get(URI));
        assertEquals("shulchanaruch-1", object.get(JBO_SEFER));
        assertEquals("דין השכמת הבוקר", object.get(JBO_SIMAN));
        assertEquals("1", object.get(JBO_POSITION_IN_SIMAN));
        assertEquals("1", object.get(JBO_POSITION));
        ...
        assertEquals("jbr:shulchanaruch-1-1-2-3", object.get(URI));
        assertEquals("shulchanaruch-1", object.get(JBO_SEFER));
        assertEquals("דין לבישת בגדים", object.get(JBO_SIMAN));
        ...
        assertEquals("jbr:shulchanaruch-perush-1-1-2-3", object.get(URI));
        assertEquals("shulchanaruch-1", object.get(JBO_SEFER));
        assertEquals("דין לבישת בגדים", object.get(JBO_SIMAN));
        assertEquals("3", object.get(JBO_POSITION_IN_SIMAN));
        assertEquals("12", object.get(JBO_POSITION));
        ...
        assertEquals("jbr:shulchanaruch-1-39-697-1", object.get(URI));
        assertEquals("shulchanaruch-1", object.get(JBO_SEFER));
        assertEquals("אין אומרים תחנה בפורים (בי''ד וט''ו שבאדר א', ודין תענית והספד בהן) ,", object.get(JBO_SIMAN));
        assertEquals("1", object.get(JBO_POSITION_IN_SIMAN));
        assertEquals("4166", object.get(JBO_POSITION));
        ...
        assertEquals("jbr:shulchanaruch-2-2-29-1", object.get(URI));
        assertEquals("shulchanaruch-2", object.get(JBO_SEFER));
        assertEquals("שמונה מיני טריפות וסימנם", object.get(JBO_SIMAN));
        assertEquals("1", object.get(JBO_POSITION_IN_SIMAN));
        ...
        assertEquals("jbr:shulchanaruch-perush-2-2-29-1", object.get(URI));
        assertEquals("shulchanaruch-2", object.get(JBO_SEFER));
        assertEquals("שמונה מיני טריפות וסימנם", object.get(JBO_SIMAN));
        assertEquals("1", object.get(JBO_POSITION_IN_SIMAN));
        assertEquals("177", object.get(JBO_POSITION));
        ...
        assertEquals("jbr:shulchanaruch-2-60-403-9", object.get(URI));
        assertEquals("shulchanaruch-2", object.get(JBO_SEFER));
        assertEquals("דיני המלקט עצמות", object.get(JBO_SIMAN));
        assertEquals("9", object.get(JBO_POSITION_IN_SIMAN));
        assertEquals("3486", object.get(JBO_POSITION));
        ...
        assertEquals("jbr:shulchanaruch-perush-2-60-403-9", object.get(URI));
        assertEquals("shulchanaruch-2", object.get(JBO_SEFER));
        assertEquals("דיני המלקט עצמות", object.get(JBO_SIMAN));
        assertEquals("9", object.get(JBO_POSITION_IN_SIMAN));
        assertEquals("3486", object.get(JBO_POSITION));
        ...
        assertEquals("jbr:shulchanaruch-3-1-1-6", object.get(URI));
        assertEquals("shulchanaruch-3", object.get(JBO_SEFER));
        assertEquals("דיני פריה ורביה, ושלא לעמד בלא אשה", object.get(JBO_SIMAN));
        ...
        assertEquals("jbr:shulchanaruch-perush-3-1-1-6", object.get(URI));
        assertEquals("shulchanaruch-3", object.get(JBO_SEFER));
        assertEquals("דיני פריה ורביה, ושלא לעמד בלא אשה", object.get(JBO_SIMAN));
        assertEquals("6", object.get(JBO_POSITION_IN_SIMAN));
        assertEquals("6", object.get(JBO_POSITION));
        ...
        assertEquals("jbr:shulchanaruch-3-8-177-4", object.get(URI));
        assertEquals("shulchanaruch-3", object.get(JBO_SEFER));
        assertEquals("הלכות אונס ומפתה", object.get(JBO_SIMAN));
        assertEquals("4", object.get(JBO_POSITION_IN_SIMAN));
        assertEquals("1869", object.get(JBO_POSITION));
        ...
        assertEquals("jbr:shulchanaruch-perush-3-8-177-4", object.get(URI));
        assertEquals("shulchanaruch-3", object.get(JBO_SEFER));
        assertEquals("הלכות אונס ומפתה", object.get(JBO_SIMAN));
        assertEquals("4", object.get(JBO_POSITION_IN_SIMAN));
        assertEquals("1869", object.get(JBO_POSITION));
        ...
        assertEquals("jbr:shulchanaruch-4-1-1-6", object.get(URI));
        assertEquals("shulchanaruch-4", object.get(JBO_SEFER));
        assertEquals("מנוי השופטים בארץ ובחוצה לארץ", object.get(JBO_SIMAN));
        assertEquals("6", object.get(JBO_POSITION_IN_SIMAN));
        assertEquals("6", object.get(JBO_POSITION));
        ...
        assertEquals("jbr:shulchanaruch-perush-4-1-1-6", object.get(URI));
        assertEquals("shulchanaruch-4", object.get(JBO_SEFER));
        assertEquals("מנוי השופטים בארץ ובחוצה לארץ", object.get(JBO_SIMAN));
        assertEquals("6", object.get(JBO_POSITION_IN_SIMAN));
        assertEquals("6", object.get(JBO_POSITION));
        ...
        assertEquals("jbr:shulchanaruch-4-41-425-3", object.get(URI));
        assertEquals("shulchanaruch-4", object.get(JBO_SEFER));
        assertEquals("חיבי מיתות בית דין, היאך דנים אותם בזמן הזה", object.get(JBO_SIMAN));
        assertEquals("3", object.get(JBO_POSITION_IN_SIMAN));
        assertEquals("3688", object.get(JBO_POSITION));
        ...
        assertEquals("jbr:shulchanaruch-perush-4-41-425-3", object.get(URI));
        assertEquals("shulchanaruch-4", object.get(JBO_SEFER));
        assertEquals("חיבי מיתות בית דין, היאך דנים אותם בזמן הזה", object.get(JBO_SIMAN));
        assertEquals("3", object.get(JBO_POSITION_IN_SIMAN));
        assertEquals("3688", object.get(JBO_POSITION));
    ...
    public void testSpecificPackages(){
        ...
        assertEquals("jbr:shulchanaruch-1-39",object.get(URI));
        assertEquals("הלכות מגילה ופורים",object.get(RDFS_LABEL));
        assertEquals("39", object.get(JBO_POSITION));
        //sefer 1 halachot 7 siman 130
        object = packageJson[1].getObject(137);
        assertEquals("jbr:shulchanaruch-1-7-130",object.get(URI));
        ...
        //sefer 2 halachot 8
        object = packageJson[2].getObject(76);
        assertEquals("jbr:shulchanaruch-2-8",object.get(URI));
        assertEquals("הלכות מליחה",object.get(RDFS_LABEL));
        assertEquals("8", object.get(JBO_POSITION));
        //sefer 2 halachot 16 siman 98
        object = packageJson[2].getObject(114);
        assertEquals("jbr:shulchanaruch-2-16-98",object.get(URI));
        ...
        assertEquals("jbr:shulchanaruch-3-6",object.get(URI));
        assertEquals("הלכות מאון",object.get(RDFS_LABEL));
        assertEquals("6", object.get(JBO_POSITION));
        //sefer 3 halachot 3 siman 26
        object = packageJson[3].getObject(29);
        assertEquals("jbr:shulchanaruch-3-3-26",object.get(URI));
        ...
        //sefer 4 halachot 2
        object = packageJson[4].getObject(29);
        assertEquals("jbr:shulchanaruch-4-2",object.get(URI));
        ...
        assertEquals("jbr:shulchanaruch-4-41-421",object.get(URI));
    ...
    private int NumOfPsukimPerSefer(int seferNum) {
        int numOfPsukimPerSefer[] = {-1, 4801, 5971, 2953, 6528};
    ...
    private int NumOfObjectsPerSeferPackage(int seferNum) {
        ...
        return 1 + numOfHalachotPerSefer[seferNum] + numOfSimanimPerSefer[seferNum];
    }
