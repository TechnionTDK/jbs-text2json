...
public class MekhiltaDeRabbiShimonBarYochaiParserTest {
    ...
    public void testSpecificPackageObjects() {
        ...
        assertLabelProperty( object ,"מכילתא דרבי שמעון בר יוחאי חלק א פרק א");
