...
public class NefeshHachaimParserTest {
    ...
    private void testObject(Map<String, String> o, int gateNum, int perekNum, String startsWith, String endsWith) {
        String UriNum = "-" + gateNum + "-" + perekNum;
        String positionNum = Integer.toString(perekNum);
        ...
        String label =  str1 + Integer.toString(gateNum) + str2 + Integer.toString(perekNum);
...
//        assertTextUriProperty( o , bookName + UriNum);
        assertPositionProperty(o, positionNum);
        String str1 = "נפש החיים שער ";
        String label = str1 + Integer.toString(gateNum);
        assertLabelProperty( o ,label);
    }
    ...
    public void testSpecificObjects() {
        ...
        testObject(o, 1, 1, startsWith, endsWith);
        ...
        testObject(o, 1, 2, startsWith, endsWith);
        ...
        testObject(o, 1, 6, startsWith, endsWith);
        ...
        testObject(o, 2, 6, startsWith, endsWith);
        ...
        testObject(o, 5, 34, startsWith, endsWith);
