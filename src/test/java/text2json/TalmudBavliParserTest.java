...
public class TalmudBavliParserTest {
    ...
    public static void setup() throws Exception {
        for (int masechetNum = NUM_OF_FIRST_MASECHET; masechetNum <= NUM_OF_LAST_MASECHET; masechetNum++) {
            ...
            createOutputFolderIfNotExists("talmudbavli");
    ...
    public void testSpecificObjects() {
        ...
        assertEquals(JBR_TEXT + "bavli-1-2-1", object.get(URI));
        //assertEquals("bavli-1", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-1-1", object.get(JBO_PEREK));
        ...
        assertBookProperty( object,"talmudbavli");

        //masechet 1 daf 2 amud 1 - perush rashi
        object = json[1].getObject(1);
        assertEquals(JBR_TEXT + "bavli-rashi-1-2-1", object.get(URI));
        //assertEquals("bavli-1", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-1-1", object.get(JBO_PEREK));
        assertEquals("רש\"י ברכות ב א", object.get(RDFS_LABEL));
        assertPositionProperty(object ,"1");
        assertEquals(JBR_TEXT + "bavli-1-2-1", object.get(JBO_INTERPRETS));
        ...
        assertEquals(text, object.get(JBO_TEXT));
        assertBookProperty( object,"rashibavli");

        //masechet 1 daf 2 amud 1 - perush tosafot
        object = json[1].getObject(2);
        assertEquals(JBR_TEXT + "bavli-tosafot-1-2-1", object.get(URI));
        //assertEquals("bavli-1", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-1-1", object.get(JBO_PEREK));
        ...
        assertEquals(text, object.get(JBO_TEXT));
        assertBookProperty( object,"tosafotbavli");

        //masechet 1 daf 64 amud 1
        object = json[1].getObject(json[1].subjects.size()-3);
        assertEquals(JBR_TEXT + "bavli-1-64-1", object.get(URI));
        //assertEquals("bavli-1", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-1-9", object.get(JBO_PEREK));
        assertEquals("מסכת ברכות סד א", object.get(RDFS_LABEL));
        assertPositionProperty(object ,"125");
        ...
        assertEquals(JBR_TEXT + "bavli-rashi-1-64-1", object.get(URI));
        //assertEquals("bavli-1", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-1-9", object.get(JBO_PEREK));
        assertEquals("רש\"י ברכות סד א", object.get(RDFS_LABEL));
        assertPositionProperty(object ,"125");
        assertEquals(JBR_TEXT + "bavli-1-64-1", object.get(JBO_INTERPRETS));
        ...
        assertEquals(JBR_TEXT + "bavli-tosafot-1-64-1", object.get(URI));
        //assertEquals("bavli-1", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-1-9", object.get(JBO_PEREK));
        ...
        assertEquals(JBR_TEXT + "bavli-2-157-2", object.get(URI));
        //assertEquals("bavli-2", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-2-24", object.get(JBO_PEREK));
        assertEquals("מסכת שבת קנז ב", object.get(RDFS_LABEL));
        assertPositionProperty(object ,"312");
        ...
        assertEquals(JBR_TEXT + "bavli-rashi-2-157-2", object.get(URI));
        //assertEquals("bavli-2", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-2-24", object.get(JBO_PEREK));
        assertEquals("רש\"י שבת קנז ב", object.get(RDFS_LABEL));
        assertPositionProperty(object ,"312");
        assertEquals(JBR_TEXT + "bavli-2-157-2", object.get(JBO_INTERPRETS));
        ...
        assertEquals(JBR_TEXT + "bavli-tosafot-2-157-2", object.get(URI));
        //assertEquals("bavli-2", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-2-24", object.get(JBO_PEREK));
        ...
        assertEquals(JBR_TEXT + "bavli-3-2-2", object.get(URI));
        //assertEquals("bavli-3", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-3-1", object.get(JBO_PEREK));
        ...
        assertEquals(JBR_TEXT + "bavli-rashi-3-2-2", object.get(URI));
        //assertEquals("bavli-3", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-3-1", object.get(JBO_PEREK));
        assertEquals("רש\"י עירובין ב ב", object.get(RDFS_LABEL));
        assertPositionProperty(object ,"2");
        assertEquals(JBR_TEXT + "bavli-3-2-2", object.get(JBO_INTERPRETS));
        ...
        assertEquals(JBR_TEXT + "bavli-tosafot-3-2-2", object.get(URI));
        //assertEquals("bavli-3", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-3-1", object.get(JBO_PEREK));
        ...
        assertEquals(JBR_TEXT + "bavli-4-21-1", object.get(URI));
        //assertEquals("bavli-4", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-4-2", object.get(JBO_PEREK));
        ...
        assertEquals(JBR_TEXT + "bavli-rashi-4-21-1", object.get(URI));
        //assertEquals("bavli-4", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-4-2", object.get(JBO_PEREK));
        assertEquals("רש\"י פסחים כא א", object.get(RDFS_LABEL));
        assertPositionProperty(object ,"39");
        assertEquals(JBR_TEXT + "bavli-4-21-1", object.get(JBO_INTERPRETS));
        ...
        assertEquals(JBR_TEXT + "bavli-tosafot-4-21-1", object.get(URI));
        //assertEquals("bavli-4", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-4-2", object.get(JBO_PEREK));
        ...
        assertEquals(JBR_TEXT + "bavli-6-87-2", object.get(URI));
        //assertEquals("bavli-6", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-6-8", object.get(JBO_PEREK));
        assertEquals("מסכת יומא פז ב", object.get(RDFS_LABEL));
        assertPositionProperty(object ,"172");
        ...
        assertEquals(JBR_TEXT + "bavli-rashi-6-87-2", object.get(URI));
        //assertEquals("bavli-6", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-6-8", object.get(JBO_PEREK));
        assertEquals("רש\"י יומא פז ב", object.get(RDFS_LABEL));
        assertPositionProperty(object ,"172");
        assertEquals(JBR_TEXT + "bavli-6-87-2", object.get(JBO_INTERPRETS));
        ...
        assertEquals(JBR_TEXT + "bavli-tosafot-6-87-2", object.get(URI));
        //assertEquals("bavli-6", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-6-8", object.get(JBO_PEREK));
        ...
        assertEquals(JBR_TEXT + "bavli-9-2-1", object.get(URI));
        //assertEquals("bavli-9", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-9-1", object.get(JBO_PEREK));
        ...
        assertEquals(JBR_TEXT + "bavli-rashi-9-2-1", object.get(URI));
        //assertEquals("bavli-9", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-9-1", object.get(JBO_PEREK));
        assertEquals("רש\"י תענית ב א", object.get(RDFS_LABEL));
        assertPositionProperty(object ,"1");
        assertEquals(JBR_TEXT + "bavli-9-2-1", object.get(JBO_INTERPRETS));
        ...
        assertEquals(JBR_TEXT + "bavli-tosafot-9-2-1", object.get(URI));
        //assertEquals("bavli-9", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-9-1", object.get(JBO_PEREK));
        ...
        assertEquals(JBR_TEXT + "bavli-12-11-2", object.get(URI));
        //assertEquals("bavli-12", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-12-1", object.get(JBO_PEREK));
        ...
        assertEquals(JBR_TEXT + "bavli-rashi-12-11-2", object.get(URI));
        //assertEquals("bavli-12", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-12-1", object.get(JBO_PEREK));
        assertEquals("רש\"י חגיגה יא ב", object.get(RDFS_LABEL));
        assertPositionProperty(object ,"20");
        assertEquals(JBR_TEXT + "bavli-12-11-2", object.get(JBO_INTERPRETS));
        ...
        assertEquals(JBR_TEXT + "bavli-tosafot-12-11-2", object.get(URI));
        //assertEquals("bavli-12", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-12-1", object.get(JBO_PEREK));
        ...
        assertEquals(JBR_TEXT + "bavli-17-2-1", object.get(URI));
        //assertEquals("bavli-17", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-17-1", object.get(JBO_PEREK));
        ...
        assertEquals(JBR_TEXT + "bavli-rashi-17-2-1", object.get(URI));
        //assertEquals("bavli-17", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-17-1", object.get(JBO_PEREK));
        assertEquals("רש\"י סוטה ב א", object.get(RDFS_LABEL));
        assertPositionProperty(object ,"1");
        assertEquals(JBR_TEXT + "bavli-17-2-1", object.get(JBO_INTERPRETS));
        ...
        assertEquals(JBR_TEXT + "bavli-tosafot-17-2-1", object.get(URI));
        //assertEquals("bavli-17", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-17-1", object.get(JBO_PEREK));
        ...
        assertEquals(JBR_TEXT + "bavli-36-25-2", object.get(URI));
        //assertEquals("bavli-36", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-36-1", object.get(JBO_PEREK));
        ...
        assertEquals(JBR_TEXT + "bavli-rashi-36-25-2", object.get(URI));
        //assertEquals("bavli-36", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-36-1", object.get(JBO_PEREK));
        assertEquals("רש\"י תמיד כה ב", object.get(RDFS_LABEL));
        assertPositionProperty(object ,"1");
        assertEquals(JBR_TEXT + "bavli-36-25-2", object.get(JBO_INTERPRETS));
        ...
        assertEquals(JBR_TEXT + "bavli-37-72-2", object.get(URI));
        //assertEquals("bavli-37", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-37-10", object.get(JBO_PEREK));
        ...
        assertEquals(JBR_TEXT + "bavli-rashi-37-72-2", object.get(URI));
        //assertEquals("bavli-37", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-37-10", object.get(JBO_PEREK));
        assertEquals("רש\"י נדה עב ב", object.get(RDFS_LABEL));
        assertPositionProperty(object ,"142");
        assertEquals(JBR_TEXT + "bavli-37-72-2", object.get(JBO_INTERPRETS));
        ...
        assertEquals(JBR_TEXT + "bavli-tosafot-37-72-2", object.get(URI));
        //assertEquals("bavli-37", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-37-10", object.get(JBO_PEREK));
        ...
        assertEquals(JBR_TEXT + "bavli-37-73-1", object.get(URI));
        //assertEquals("bavli-37", object.get(JBO_MASECHET));
        //assertEquals(JBR_TEXT + "bavli-perek-37-10", object.get(JBO_PEREK));
        assertEquals("מסכת נדה עג א", object.get(RDFS_LABEL));
        assertPositionProperty(object ,"143");
