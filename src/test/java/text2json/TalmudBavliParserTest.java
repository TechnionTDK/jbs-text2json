...
public class TalmudBavliParserTest {
    ...
    public void testSpecificObjects() {
        ...
        assertEquals("1", object.get(JBO_POSITION));
        assertEquals("jbr:bavli-1-2-1", object.get(JBO_EXPLAINS));
        ...
        assertEquals("125", object.get(JBO_POSITION));
        assertEquals("jbr:bavli-1-64-1", object.get(JBO_EXPLAINS));
        ...
        assertEquals("312", object.get(JBO_POSITION));
        assertEquals("jbr:bavli-2-157-2", object.get(JBO_EXPLAINS));
        ...
        assertEquals("2", object.get(JBO_POSITION));
        assertEquals("jbr:bavli-3-2-2", object.get(JBO_EXPLAINS));
        ...
        assertEquals("39", object.get(JBO_POSITION));
        assertEquals("jbr:bavli-4-21-1", object.get(JBO_EXPLAINS));
        ...
        assertEquals("172", object.get(JBO_POSITION));
        assertEquals("jbr:bavli-6-87-2", object.get(JBO_EXPLAINS));
        ...
        assertEquals("1", object.get(JBO_POSITION));
        assertEquals("jbr:bavli-9-2-1", object.get(JBO_EXPLAINS));
        ...
        assertEquals("20", object.get(JBO_POSITION));
        assertEquals("jbr:bavli-12-11-2", object.get(JBO_EXPLAINS));
        ...
        assertEquals("1", object.get(JBO_POSITION));
        assertEquals("jbr:bavli-17-2-1", object.get(JBO_EXPLAINS));
        ...
        assertEquals("1", object.get(JBO_POSITION));
        assertEquals("jbr:bavli-36-25-2", object.get(JBO_EXPLAINS));
        ...
        assertEquals("142", object.get(JBO_POSITION));
        assertEquals("jbr:bavli-37-72-2", object.get(JBO_EXPLAINS));
