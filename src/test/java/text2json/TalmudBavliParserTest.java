...
public class TalmudBavliParserTest {
    ...
    public void testSpecificObjects() {
        ...
        assertBookProperty("talmudbavli", object.get(JBO_BOOK));
        ...
        assertEquals(text, object.get(JBO_TEXT));
        assertBookProperty("rashibavli", object.get(JBO_BOOK));
        ...
        assertEquals(text, object.get(JBO_TEXT));
        assertBookProperty("tosafotbavli", object.get(JBO_BOOK));
