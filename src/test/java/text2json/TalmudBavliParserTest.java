...
public class TalmudBavliParserTest {
    ...
    public void testSpecificObjects() {
        ...
        assertEquals("פרק ראשון - מבוי שהוא גבוה", object.get(JBO_PEREK));
        assertEquals("עירובין ב ב", object.get(RDFS_LABEL));
        ...
        assertEquals("bavli-3", object.get(JBO_MASECHET));
        assertEquals("פרק ראשון - מבוי שהוא גבוה", object.get(JBO_PEREK));
        assertEquals("רשי עירובין ב ב", object.get(RDFS_LABEL));
        assertEquals("2", object.get(JBO_POSITION));
        assertEquals("jbr:bavli-3-2-2", object.get(JBO_MEFARESH));
        ...
        assertEquals("פרק שני - כל שעה", object.get(JBO_PEREK));
        ...
        assertEquals("bavli-4", object.get(JBO_MASECHET));
        assertEquals("פרק שני - כל שעה", object.get(JBO_PEREK));
        assertEquals("רשי פסחים כא א", object.get(RDFS_LABEL));
        assertEquals("39", object.get(JBO_POSITION));
        assertEquals("jbr:bavli-4-21-1", object.get(JBO_MEFARESH));
        ...
        assertEquals("פרק שמיני - יום הכיפורים", object.get(JBO_PEREK));
        assertEquals("יומא פז ב", object.get(RDFS_LABEL));
        ...
        assertEquals("bavli-6", object.get(JBO_MASECHET));
        assertEquals("פרק שמיני - יום הכיפורים", object.get(JBO_PEREK));
        assertEquals("רשי יומא פז ב", object.get(RDFS_LABEL));
        assertEquals("172", object.get(JBO_POSITION));
        assertEquals("jbr:bavli-6-87-2", object.get(JBO_MEFARESH));
        ...
        assertEquals("פרק ראשון - מאימתי", object.get(JBO_PEREK));
        assertEquals("תענית ב א", object.get(RDFS_LABEL));
        assertEquals("1", object.get(JBO_POSITION));
        ...
        assertEquals("bavli-9", object.get(JBO_MASECHET));
        assertEquals("פרק ראשון - מאימתי", object.get(JBO_PEREK));
        assertEquals("רשי תענית ב א", object.get(RDFS_LABEL));
        assertEquals("1", object.get(JBO_POSITION));
        assertEquals("jbr:bavli-9-2-1", object.get(JBO_MEFARESH));
        ...
        assertEquals("פרק ראשון - הכל חייבין", object.get(JBO_PEREK));
        assertEquals("חגיגה יא ב", object.get(RDFS_LABEL));
        ...
        assertEquals("bavli-12", object.get(JBO_MASECHET));
        assertEquals("פרק ראשון - הכל חייבין", object.get(JBO_PEREK));
        assertEquals("רשי חגיגה יא ב", object.get(RDFS_LABEL));
        assertEquals("20", object.get(JBO_POSITION));
        assertEquals("jbr:bavli-12-11-2", object.get(JBO_MEFARESH));
        ...
        assertEquals("פרק ראשון - המקנא", object.get(JBO_PEREK));
        assertEquals("סוטה ב א", object.get(RDFS_LABEL));
        assertEquals("1", object.get(JBO_POSITION));
        ...
        assertEquals("bavli-17", object.get(JBO_MASECHET));
        assertEquals("פרק ראשון - המקנא", object.get(JBO_PEREK));
        assertEquals("רשי סוטה ב א", object.get(RDFS_LABEL));
        assertEquals("1", object.get(JBO_POSITION));
        assertEquals("jbr:bavli-17-2-1", object.get(JBO_MEFARESH));
        ...
        assertEquals("פרק ראשון - בשלשה מקומות", object.get(JBO_PEREK));
        assertEquals("תמיד כה ב", object.get(RDFS_LABEL));
        assertEquals("1", object.get(JBO_POSITION));
        ...
        assertEquals("bavli-36", object.get(JBO_MASECHET));
        assertEquals("פרק ראשון - בשלשה מקומות", object.get(JBO_PEREK));
        assertEquals("רשי תמיד כה ב", object.get(RDFS_LABEL));
        assertEquals("1", object.get(JBO_POSITION));
        assertEquals("jbr:bavli-36-25-2", object.get(JBO_MEFARESH));
        ...
        assertEquals("פרק עשירי - תינוקת", object.get(JBO_PEREK));
        assertEquals("נדה עב ב", object.get(RDFS_LABEL));
        ...
        assertEquals("bavli-37", object.get(JBO_MASECHET));
        assertEquals("פרק עשירי - תינוקת", object.get(JBO_PEREK));
        assertEquals("רשי נדה עב ב", object.get(RDFS_LABEL));
        assertEquals("142", object.get(JBO_POSITION));
        assertEquals("jbr:bavli-37-72-2", object.get(JBO_MEFARESH));
        ...
        assertEquals("bavli-37", object.get(JBO_MASECHET));
        assertEquals("פרק עשירי - תינוקת", object.get(JBO_PEREK));
        assertEquals("נדה עג א", object.get(RDFS_LABEL));
    ...
    public void testSpecificPackages() {
        ...
        assertEquals("ברכות", object.get(RDFS_LABEL));
        assertEquals("1", object.get(JBO_POSITION));
        //masechet 1 perek 3
        object = packageJson[1].getObject(19);
        assertEquals("jbr:bavli-1-perek:3", object.get(URI));
        ...
        assertEquals("פסחים", object.get(RDFS_LABEL));
        assertEquals("4", object.get(JBO_POSITION));

        //masechet 7 perek 2
        object = packageJson[7].getObject(21);
        assertEquals("jbr:bavli-7-perek:2", object.get(URI));
        ...
        assertEquals("קידושין", object.get(RDFS_LABEL));
        assertEquals("19", object.get(JBO_POSITION));

        //masechet 25 perek 8
        object = packageJson[25].getObject(packageJson[25].subjects.size()-1);
        assertEquals("jbr:bavli-25-perek:8", object.get(URI));
